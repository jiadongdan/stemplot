...
def plot_heatmap(data, ax=None, xlabels=None, ylabels=None, xtick='bottom',
                 xrotate=-30, cbar_kw=None, cbarlabel="", **kwargs):
    """
    ...
    **kwargs
    ...
    if xlabels is not None:
        ax.set_xticks(np.arange(data.shape[1]), labels=xlabels)
    if ylabels is not None:
        ax.set_yticks(np.arange(data.shape[0]), labels=ylabels)
    ...
    plt.setp(ax.get_xticklabels(), rotation=xrotate, ha="right",
