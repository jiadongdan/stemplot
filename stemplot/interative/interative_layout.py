...
class InteractiveCluster:
    ...
    def __init__(self, fig, X, ps, lbs=None, clip=True, max_samples=15, rotate=False, **kwargs):
        self.fig = fig
...
def interactive_clusters(X, ps, lbs=None, clip=True, max_samples=15, rotate=False, **kwargs):
    fig, ax = plt.subplots(1, 2, figsize=(12, 6))
    app = InteractiveCluster(fig, X, ps, lbs, clip, max_samples, rotate, **kwargs)
    return app
